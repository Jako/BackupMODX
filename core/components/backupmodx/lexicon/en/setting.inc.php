...
$_lang['setting_backupmodx.debug_desc'] = 'Log debug information in the MODX error log.';
$_lang['setting_backupmodx.excludeFiles'] = 'Exclude Files';
$_lang['setting_backupmodx.excludeFiles_desc'] = 'Comma-separated list of files to be excluded from the backup. Regular expressions are possible. Example: \..* for file names, that start with a dot.';
$_lang['setting_backupmodx.excludeFolders'] = 'Exclude Folders';
$_lang['setting_backupmodx.excludeFolders_desc'] = 'Comma-separated list of folders to be excluded from the backup. Path placeholder are available. Example: {assets_path}uploads/';
$_lang['setting_backupmodx.groups'] = 'Groups';
$_lang['setting_backupmodx.groups_desc'] = 'Comma separated list of usergroups names, that will have access to the widget.';
$_lang['setting_backupmodx.targetPath'] = 'Backup Target Path';
$_lang['setting_backupmodx.targetPath_desc'] = 'The path to the folder to store the backups. Path placeholder are available. Example: {core_path}backup/';
